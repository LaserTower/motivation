...
class DenisEntityFabric
{
     ...
     * @param array $object
     */
    public function createEntity(int $group_id, ?string $secret, string $type, array $object)
    {
        $object['myyyyytype'] = $type;
        print_r($object);
        switch ($type) {
            ...
            /* 
                        case static::CALLBACK_EVENT_MESSAGE_REPLY:
                            return $this->messageReply($group_id, $secret, $object);                          break; /* 
